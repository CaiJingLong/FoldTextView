package com.dn.foldtextview.view;
        ...
        setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isExpand) {
                    ...
                    RotateAnimation animation = new RotateAnimation(0, 180, Animation.RELATIVE_TO_SELF, 0.5f, Animation.RELATIVE_TO_SELF,
                            0.5f);
